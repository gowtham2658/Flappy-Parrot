/**
 * @author Moses Odhiambo / https://github.com/moses-odhiambo
 */
...
let up, down, front, planes = [], z, dZ = 0, yMax, zMax = 0.5, dRot, collided = false;   //collision
...
let score = 0, scoreLabel, gameOver = false;  //score
let flapSound, hitSound, metalSound, scoreSound;    //sound effects
